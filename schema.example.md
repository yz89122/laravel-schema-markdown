...
| Column                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-api_settings-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-api_settings-key">`key`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-api_settings-value">`value`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-api_settings-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-api_settings-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                          | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-banlist-id">`id`</span>                         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-banlist-created_at">`created_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-banlist-updated_at">`updated_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                            | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-bar_notifications-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-bar_notifications-key">`key`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-bar_notifications-value">`value`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-bar_notifications-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-bar_notifications-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                          | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-canned_response-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-canned_response-user_id">`user_id`</span>       | `integer(unsigned)` |          |         |                      |         |
| <span id="table-canned_response-title">`title`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-canned_response-message">`message`</span>       | `text`              |          |         |                      |         |
| <span id="table-canned_response-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-canned_response-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                  | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-common_settings-id">`id`</span>                         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-common_settings-created_at">`created_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-common_settings-updated_at">`updated_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                     | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-conditions-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-conditions-job">`job`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-conditions-value">`value`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-conditions-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-conditions-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-country_code-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-country_code-numcode">`numcode`</span>       | `smallInteger`      |          |         |                      |         |
| <span id="table-country_code-phonecode">`phonecode`</span>   | `integer`           |          |         |                      |         |
| <span id="table-country_code-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-country_code-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                             | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-custom_form_fields-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-custom_form_fields-forms_id">`forms_id`</span>     | `integer`           |          |         |                      |         |
...
| <span id="table-custom_form_fields-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-custom_form_fields-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-custom_forms-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-custom_forms-formname">`formname`</span>     | `string(255)`       |          |         |                      |         |
| <span id="table-custom_forms-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-custom_forms-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                              | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-date_format-id">`id`</span>         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| Column                                                   | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-date_time_format-id">`id`</span>         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| Column                                                                           | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-department-id">`id`</span>                                       | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-department-name">`name`</span>                                   | `string(255)`       |          |         |                      |         |
| <span id="table-department-type">`type`</span>                                   | `string(255)`       |          |         |                      |         |
| <span id="table-department-sla">`sla`</span>                                     | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-department-manager">`manager`</span>                             | `integer(unsigned)` | `true`   |         |                      |         |
...
| <span id="table-department-created_at">`created_at`</span>                       | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-department-updated_at">`updated_at`</span>                       | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                   | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-emails-id">`id`</span>                                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-emails-department">`department`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-emails-priority">`priority`</span>                       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-emails-help_topic">`help_topic`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-emails-user_name">`user_name`</span>                     | `string(255)`       | `true`   |         |                      |         |
...
| <span id="table-emails-created_at">`created_at`</span>                   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-emails-updated_at">`updated_at`</span>                   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                      | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-failed_jobs-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-failed_jobs-failed_at">`failed_at`</span>   | `timestamp(0)`      |          |         | `useCurrent:true`    |         |
...
| Column                                                      | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-faveo_mails-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-faveo_mails-email_id">`email_id`</span>     | `integer`           |          |         |                      |         |
...
| <span id="table-faveo_mails-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-faveo_mails-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-faveo_queues-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-faveo_queues-service_id">`service_id`</span> | `integer`           |          |         |                      |         |
| <span id="table-faveo_queues-key">`key`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-faveo_queues-value">`value`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-faveo_queues-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-faveo_queues-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-field_values-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-field_values-field_id">`field_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-field_values-child_id">`child_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-field_values-field_key">`field_key`</span>     | `string(255)`       | `true`   |         |                      |         |
| <span id="table-field_values-field_value">`field_value`</span> | `string(255)`       | `true`   |         |                      |         |
| <span id="table-field_values-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-field_values-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                        | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-group_assign_department-id">`id`</span>                       | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-group_assign_department-group_id">`group_id`</span>           | `integer(unsigned)` |          |         |                      |         |
| <span id="table-group_assign_department-department_id">`department_id`</span> | `integer(unsigned)` |          |         |                      |         |
| <span id="table-group_assign_department-created_at">`created_at`</span>       | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-group_assign_department-updated_at">`updated_at`</span>       | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                     | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-groups-id">`id`</span>                                     | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-groups-created_at">`created_at`</span>                     | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-groups-updated_at">`updated_at`</span>                     | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                   | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-help_topic-id">`id`</span>                               | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-help_topic-topic">`topic`</span>                         | `string(255)`       |          |         |                      |         |
| <span id="table-help_topic-parent_topic">`parent_topic`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-help_topic-custom_form">`custom_form`</span>             | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-help_topic-department">`department`</span>               | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-help_topic-ticket_status">`ticket_status`</span>         | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-help_topic-priority">`priority`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-help_topic-sla_plan">`sla_plan`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
...
| <span id="table-help_topic-auto_assign">`auto_assign`</span>             | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-help_topic-auto_response">`auto_response`</span>         | `boolean`           |          |         |                      |         |
| <span id="table-help_topic-created_at">`created_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-help_topic-updated_at">`updated_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                   | Type                    | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------- | ----------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-jobs-id">`id`</span>                     | `bigInteger(unsigned)`  |          |         | `autoIncrement:true` |         |
| <span id="table-jobs-queue">`queue`</span>               | `string(255)`           |          |         |                      |         |
| <span id="table-jobs-payload">`payload`</span>           | `longText`              |          |         |                      |         |
| <span id="table-jobs-attempts">`attempts`</span>         | `tinyInteger(unsigned)` |          |         |                      |         |
| <span id="table-jobs-reserved">`reserved`</span>         | `tinyInteger(unsigned)` |          |         |                      |         |
| <span id="table-jobs-reserved_at">`reserved_at`</span>   | `integer(unsigned)`     | `true`   |         |                      |         |
| <span id="table-jobs-available_at">`available_at`</span> | `integer(unsigned)`     |          |         |                      |         |
| <span id="table-jobs-created_at">`created_at`</span>     | `integer(unsigned)`     |          |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-kb_article-id">`id`</span>                     | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-kb_article-publish_time">`publish_time`</span> | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-kb_article-created_at">`created_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-kb_article-updated_at">`updated_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                    | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-kb_article_relationship-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-kb_article_relationship-article_id">`article_id`</span>   | `integer(unsigned)` |          |         |                      |         |
| <span id="table-kb_article_relationship-category_id">`category_id`</span> | `integer(unsigned)` |          |         |                      |         |
| <span id="table-kb_article_relationship-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-kb_article_relationship-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                        | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-kb_category-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-kb_category-parent">`parent`</span>           | `integer`           |          |         |                      |         |
| <span id="table-kb_category-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-kb_category-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                     | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-kb_comment-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-kb_comment-article_id">`article_id`</span> | `integer(unsigned)` |          |         |                      |         |
...
| <span id="table-kb_comment-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-kb_comment-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                     | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-kb_pages-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-kb_pages-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-kb_pages-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                      | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-kb_settings-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-kb_settings-pagination">`pagination`</span> | `integer`           |          |         |                      |         |
| <span id="table-kb_settings-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-kb_settings-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                            | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-languages-id">`id`</span>         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| Column                                                           | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-log_notification-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-log_notification-log">`log`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-log_notification-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-log_notification-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-login_attempts-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-login_attempts-LastLogin">`LastLogin`</span>   | `dateTime(0)`       |          |         |                      |         |
| <span id="table-login_attempts-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-login_attempts-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                        | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-mail_services-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-mail_services-name">`name`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-mail_services-short_name">`short_name`</span> | `string(255)`       |          |         |                      |         |
| <span id="table-mail_services-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-mail_services-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                 | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-mailbox_protocol-id">`id`</span>       | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-mailbox_protocol-name">`name`</span>   | `string(255)`       |          |         |                      |         |
| <span id="table-mailbox_protocol-value">`value`</span> | `string(50)`        | `true`   |         |                      |         |
...
| Column                                                             | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-notification_types-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-notification_types-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-notification_types-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-notifications-id">`id`</span>                         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-notifications-model_id">`model_id`</span>             | `integer`           |          |         |                      |         |
| <span id="table-notifications-userid_created">`userid_created`</span> | `integer`           |          |         |                      |         |
| <span id="table-notifications-type_id">`type_id`</span>               | `integer`           |          |         |                      |         |
| <span id="table-notifications-created_at">`created_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-notifications-updated_at">`updated_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                               | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-organization-id">`id`</span>                         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-organization-head">`head`</span>                     | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-organization-internal_notes">`internal_notes`</span> | `string(255)`       |          |         |                      |         |
| <span id="table-organization-created_at">`created_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-organization-updated_at">`updated_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
...
| <span id="table-password_resets-created_at">`created_at`</span> | `dateTime(0)` |          | `0000-00-00 00:00:00` |            |         |
...
| Column                                                  | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-plugins-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-plugins-name">`name`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-plugins-path">`path`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-plugins-status">`status`</span>         | `integer`           |          |         |                      |         |
| <span id="table-plugins-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-plugins-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-queue_services-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-queue_services-name">`name`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-queue_services-short_name">`short_name`</span> | `string(255)`       |          |         |                      |         |
| <span id="table-queue_services-status">`status`</span>         | `integer`           |          |         |                      |         |
| <span id="table-queue_services-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-queue_services-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-rating_ref-id">`id`</span>                     | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-rating_ref-rating_id">`rating_id`</span>       | `integer`           |          |         |                      |         |
| <span id="table-rating_ref-ticket_id">`ticket_id`</span>       | `integer`           |          |         |                      |         |
| <span id="table-rating_ref-thread_id">`thread_id`</span>       | `integer`           |          |         |                      |         |
| <span id="table-rating_ref-rating_value">`rating_value`</span> | `integer`           |          |         |                      |         |
| <span id="table-rating_ref-created_at">`created_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-rating_ref-updated_at">`updated_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                  | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ratings-id">`id`</span>                                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-ratings-name">`name`</span>                             | `string(255)`       |          |         |                      |         |
| <span id="table-ratings-display_order">`display_order`</span>           | `integer`           |          |         |                      |         |
| <span id="table-ratings-allow_modification">`allow_modification`</span> | `integer`           |          |         |                      |         |
| <span id="table-ratings-rating_scale">`rating_scale`</span>             | `integer`           |          |         |                      |         |
| <span id="table-ratings-rating_area">`rating_area`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-ratings-restrict">`restrict`</span>                     | `string(255)`       |          |         |                      |         |
| <span id="table-ratings-created_at">`created_at`</span>                 | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ratings-updated_at">`updated_at`</span>                 | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                                                          | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_alert_notice-id">`id`</span>                                                           | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-settings_alert_notice-created_at">`created_at`</span>                                           | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_alert_notice-updated_at">`updated_at`</span>                                           | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                             | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_auto_response-id">`id`</span>                             | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-settings_auto_response-created_at">`created_at`</span>             | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_auto_response-updated_at">`updated_at`</span>             | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                               | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_company-id">`id`</span>                     | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-settings_company-created_at">`created_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_company-updated_at">`updated_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                         | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_email-id">`id`</span>                                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-settings_email-template">`template`</span>                     | `string(255)`       |          |         |                      |         |
| <span id="table-settings_email-sys_email">`sys_email`</span>                   | `string(255)`       | `true`   |         |                      |         |
...
| <span id="table-settings_email-created_at">`created_at`</span>                 | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_email-updated_at">`updated_at`</span>                 | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                             | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_ratings-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-settings_ratings-rating_name">`rating_name`</span> | `string(255)`       |          |         |                      |         |
| <span id="table-settings_ratings-publish">`publish`</span>         | `integer`           |          |         |                      |         |
| <span id="table-settings_ratings-modify">`modify`</span>           | `integer`           |          |         |                      |         |
| <span id="table-settings_ratings-slug">`slug`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-settings_ratings-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_ratings-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                            | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_security-id">`id`</span>                                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-settings_security-lockout_message">`lockout_message`</span>       | `string(255)`       |          |         |                      |         |
| <span id="table-settings_security-backlist_offender">`backlist_offender`</span>   | `integer`           |          |         |                      |         |
| <span id="table-settings_security-backlist_threshold">`backlist_threshold`</span> | `integer`           |          |         |                      |         |
| <span id="table-settings_security-lockout_period">`lockout_period`</span>         | `integer`           |          |         |                      |         |
| <span id="table-settings_security-days_to_keep_logs">`days_to_keep_logs`</span>   | `integer`           |          |         |                      |         |
| <span id="table-settings_security-created_at">`created_at`</span>                 | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_security-updated_at">`updated_at`</span>                 | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                        | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_system-id">`id`</span>                               | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-settings_system-api_enable">`api_enable`</span>               | `integer`           |          |         |                      |         |
| <span id="table-settings_system-api_key_mandatory">`api_key_mandatory`</span> | `integer`           |          |         |                      |         |
...
| <span id="table-settings_system-time_farmat">`time_farmat`</span>             | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-settings_system-date_format">`date_format`</span>             | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-settings_system-date_time_format">`date_time_format`</span>   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-settings_system-day_date_time">`day_date_time`</span>         | `string(255)`       |          |         |                      |         |
| <span id="table-settings_system-time_zone">`time_zone`</span>                 | `integer(unsigned)` | `true`   |         |                      |         |
...
| <span id="table-settings_system-created_at">`created_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_system-updated_at">`updated_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                                | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-settings_ticket-id">`id`</span>                                       | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-settings_ticket-created_at">`created_at`</span>                       | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-settings_ticket-updated_at">`updated_at`</span>                       | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                           | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-sla_plan-id">`id`</span>                         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-sla_plan-created_at">`created_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-sla_plan-updated_at">`updated_at`</span>         | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-social_media-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-social_media-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-social_media-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                            | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-team_assign_agent-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-team_assign_agent-team_id">`team_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-team_assign_agent-agent_id">`agent_id`</span>     | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-team_assign_agent-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-team_assign_agent-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                    | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-teams-id">`id`</span>                     | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-teams-name">`name`</span>                 | `string(255)`       |          |         |                      |         |
| <span id="table-teams-status">`status`</span>             | `boolean`           |          |         |                      |         |
| <span id="table-teams-team_lead">`team_lead`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-teams-assign_alert">`assign_alert`</span> | `boolean`           |          |         |                      |         |
| <span id="table-teams-admin_notes">`admin_notes`</span>   | `string(255)`       |          |         |                      |         |
| <span id="table-teams-created_at">`created_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-teams-updated_at">`updated_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                         | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-template-id">`id`</span>                                       | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-template-created_at">`created_at`</span>                       | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-template-updated_at">`updated_at`</span>                       | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                        | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-template_sets-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-template_sets-name">`name`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-template_sets-active">`active`</span>         | `integer`           |          |         |                      |         |
| <span id="table-template_sets-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-template_sets-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-template_types-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-template_types-name">`name`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-template_types-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-template_types-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                      | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-templates-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-templates-name">`name`</span>               | `string(255)`       |          |         |                      |         |
| <span id="table-templates-variable">`variable`</span>       | `string(255)`       |          |         |                      |         |
| <span id="table-templates-type">`type`</span>               | `integer`           |          |         |                      |         |
...
| <span id="table-templates-set_id">`set_id`</span>           | `integer`           |          |         |                      |         |
| <span id="table-templates-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-templates-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                            | Type                | Nullable | Default | Attributes           | Comment                   |
| ----------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------------------------- |
| <span id="table-ticket_attachment-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |                           |
| <span id="table-ticket_attachment-name">`name`</span>             | `string(255)`       |          |         |                      |                           |
| <span id="table-ticket_attachment-thread_id">`thread_id`</span>   | `integer(unsigned)` | `true`   |         |                      |                           |
...
| <span id="table-ticket_attachment-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |                           |
| <span id="table-ticket_attachment-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |                           |
...
| Column                                                              | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_collaborator-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-ticket_collaborator-isactive">`isactive`</span>     | `boolean`           |          |         |                      |         |
| <span id="table-ticket_collaborator-ticket_id">`ticket_id`</span>   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-ticket_collaborator-user_id">`user_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-ticket_collaborator-role">`role`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-ticket_collaborator-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ticket_collaborator-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                           | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_form_data-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-ticket_form_data-ticket_id">`ticket_id`</span>   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-ticket_form_data-title">`title`</span>           | `text`              |          |         |                      |         |
| <span id="table-ticket_form_data-content">`content`</span>       | `text`              |          |         |                      |         |
| <span id="table-ticket_form_data-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ticket_form_data-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                      | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_priority-priority_id">`priority_id`</span>           | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-ticket_priority-created_at">`created_at`</span>             | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ticket_priority-updated_at">`updated_at`</span>             | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                      | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_source-id">`id`</span>               | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| Column                                                        | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_status-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-ticket_status-name">`name`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-ticket_status-state">`state`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-ticket_status-mode">`mode`</span>             | `integer`           |          |         |                      |         |
| <span id="table-ticket_status-message">`message`</span>       | `string(255)`       |          |         |                      |         |
| <span id="table-ticket_status-flags">`flags`</span>           | `integer`           |          |         |                      |         |
| <span id="table-ticket_status-sort">`sort`</span>             | `integer`           |          |         |                      |         |
| <span id="table-ticket_status-email_user">`email_user`</span> | `integer`           |          |         |                      |         |
...
| <span id="table-ticket_status-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ticket_status-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                            | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_thread-id">`id`</span>                     | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-ticket_thread-ticket_id">`ticket_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-ticket_thread-user_id">`user_id`</span>           | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-ticket_thread-poster">`poster`</span>             | `string(255)`       |          |         |                      |         |
| <span id="table-ticket_thread-source">`source`</span>             | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-ticket_thread-reply_rating">`reply_rating`</span> | `integer`           |          |         |                      |         |
| <span id="table-ticket_thread-rating_count">`rating_count`</span> | `integer`           |          |         |                      |         |
...
| <span id="table-ticket_thread-created_at">`created_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ticket_thread-updated_at">`updated_at`</span>     | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-ticket_token-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-ticket_token-ticket_id">`ticket_id`</span>   | `integer`           |          |         |                      |         |
| <span id="table-ticket_token-token">`token`</span>           | `string(255)`       |          |         |                      |         |
| <span id="table-ticket_token-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-ticket_token-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                              | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-tickets-id">`id`</span>                             | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-tickets-ticket_number">`ticket_number`</span>       | `string(255)`       |          |         |                      |         |
| <span id="table-tickets-user_id">`user_id`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-dept_id">`dept_id`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-team_id">`team_id`</span>                   | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-priority_id">`priority_id`</span>           | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-sla">`sla`</span>                           | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-help_topic_id">`help_topic_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-status">`status`</span>                     | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-rating">`rating`</span>                     | `boolean`           |          |         |                      |         |
| <span id="table-tickets-ratingreply">`ratingreply`</span>           | `boolean`           |          |         |                      |         |
| <span id="table-tickets-flags">`flags`</span>                       | `integer`           |          |         |                      |         |
| <span id="table-tickets-ip_address">`ip_address`</span>             | `integer`           |          |         |                      |         |
| <span id="table-tickets-assigned_to">`assigned_to`</span>           | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-lock_by">`lock_by`</span>                   | `integer`           |          |         |                      |         |
| <span id="table-tickets-lock_at">`lock_at`</span>                   | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-tickets-source">`source`</span>                     | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-tickets-isoverdue">`isoverdue`</span>               | `integer`           |          |         |                      |         |
| <span id="table-tickets-reopened">`reopened`</span>                 | `integer`           |          |         |                      |         |
| <span id="table-tickets-isanswered">`isanswered`</span>             | `integer`           |          |         |                      |         |
| <span id="table-tickets-html">`html`</span>                         | `integer`           |          |         |                      |         |
| <span id="table-tickets-is_deleted">`is_deleted`</span>             | `integer`           |          |         |                      |         |
| <span id="table-tickets-closed">`closed`</span>                     | `integer`           |          |         |                      |         |
| <span id="table-tickets-is_transferred">`is_transferred`</span>     | `boolean`           |          |         |                      |         |
| <span id="table-tickets-transferred_at">`transferred_at`</span>     | `dateTime(0)`       |          |         |                      |         |
| <span id="table-tickets-reopened_at">`reopened_at`</span>           | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-tickets-duedate">`duedate`</span>                   | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-tickets-closed_at">`closed_at`</span>               | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-tickets-last_message_at">`last_message_at`</span>   | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-tickets-last_response_at">`last_response_at`</span> | `dateTime(0)`       | `true`   |         |                      |         |
| <span id="table-tickets-approval">`approval`</span>                 | `integer`           |          |         |                      |         |
| <span id="table-tickets-follow_up">`follow_up`</span>               | `integer`           |          |         |                      |         |
| <span id="table-tickets-created_at">`created_at`</span>             | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-tickets-updated_at">`updated_at`</span>             | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                              | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-time_format-id">`id`</span>         | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| Column                                               | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-timezone-id">`id`</span>             | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| Column                                                                | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-user_additional_infos-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-user_additional_infos-owner">`owner`</span>           | `integer`           |          |         |                      |         |
...
| <span id="table-user_additional_infos-value">`value`</span>           | `string(255)`       | `true`   |         |                      |         |
| <span id="table-user_additional_infos-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-user_additional_infos-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                   | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------------ | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-user_assign_organization-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-user_assign_organization-org_id">`org_id`</span>         | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-user_assign_organization-user_id">`user_id`</span>       | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-user_assign_organization-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-user_assign_organization-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                      | Type                | Nullable | Default | Attributes           | Comment |
| --------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-user_notification-id">`id`</span>                           | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-user_notification-notification_id">`notification_id`</span> | `integer`           |          |         |                      |         |
| <span id="table-user_notification-user_id">`user_id`</span>                 | `integer`           |          |         |                      |         |
| <span id="table-user_notification-is_read">`is_read`</span>                 | `integer`           |          |         |                      |         |
| <span id="table-user_notification-created_at">`created_at`</span>           | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-user_notification-updated_at">`updated_at`</span>           | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                              | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-users-id">`id`</span>                               | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-users-assign_group">`assign_group`</span>           | `integer(unsigned)` | `true`   |         |                      |         |
| <span id="table-users-primary_dpt">`primary_dpt`</span>             | `integer(unsigned)` | `true`   |         |                      |         |
...
| <span id="table-users-remember_token">`remember_token`</span>       | `string(100)`       | `true`   |         |                      |         |
| <span id="table-users-created_at">`created_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-users-updated_at">`updated_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-users-user_language">`user_language`</span>         | `string(10)`        | `true`   |         |                      |         |
...
| Column                                                                  | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-version_check-id">`id`</span>                           | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
...
| <span id="table-version_check-created_at">`created_at`</span>           | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-version_check-updated_at">`updated_at`</span>           | `timestamp(0)`      | `true`   |         |                      |         |
...
| <span id="table-widgets-name">`name`</span>             | `string(30)`   | `true`   |         |                      |         |
| <span id="table-widgets-title">`title`</span>           | `string(50)`   | `true`   |         |                      |         |
| <span id="table-widgets-value">`value`</span>           | `text`         | `true`   |         |                      |         |
| <span id="table-widgets-created_at">`created_at`</span> | `timestamp(0)` | `true`   |         |                      |         |
| <span id="table-widgets-updated_at">`updated_at`</span> | `timestamp(0)` | `true`   |         |                      |         |
...
| Column                                                            | Type                | Nullable | Default | Attributes           | Comment |
| ----------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-workflow_action-id">`id`</span>                   | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-workflow_action-workflow_id">`workflow_id`</span> | `integer(unsigned)` |          |         |                      |         |
...
| <span id="table-workflow_action-created_at">`created_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-workflow_action-updated_at">`updated_at`</span>   | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                         | Type                | Nullable | Default | Attributes           | Comment |
| -------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-workflow_close-id">`id`</span>                 | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-workflow_close-days">`days`</span>             | `integer`           |          |         |                      |         |
| <span id="table-workflow_close-condition">`condition`</span>   | `integer`           |          |         |                      |         |
| <span id="table-workflow_close-send_email">`send_email`</span> | `integer`           |          |         |                      |         |
| <span id="table-workflow_close-status">`status`</span>         | `integer`           |          |         |                      |         |
| <span id="table-workflow_close-created_at">`created_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-workflow_close-updated_at">`updated_at`</span> | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                              | Type                | Nullable | Default | Attributes           | Comment |
| ------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-workflow_name-id">`id`</span>                       | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-workflow_name-name">`name`</span>                   | `string(255)`       |          |         |                      |         |
| <span id="table-workflow_name-status">`status`</span>               | `integer`           |          |         |                      |         |
| <span id="table-workflow_name-order">`order`</span>                 | `integer`           |          |         |                      |         |
...
| <span id="table-workflow_name-created_at">`created_at`</span>       | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-workflow_name-updated_at">`updated_at`</span>       | `timestamp(0)`      | `true`   |         |                      |         |
...
| Column                                                                       | Type                | Nullable | Default | Attributes           | Comment |
| ---------------------------------------------------------------------------- | ------------------- | -------- | ------- | -------------------- | ------- |
| <span id="table-workflow_rules-id">`id`</span>                               | `integer(unsigned)` |          |         | `autoIncrement:true` |         |
| <span id="table-workflow_rules-workflow_id">`workflow_id`</span>             | `integer(unsigned)` |          |         |                      |         |
...
| <span id="table-workflow_rules-created_at">`created_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
| <span id="table-workflow_rules-updated_at">`updated_at`</span>               | `timestamp(0)`      | `true`   |         |                      |         |
